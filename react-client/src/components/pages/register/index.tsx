    ...
    <ThemeProvider theme={defaultTheme}>
      <div style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <Grid container component="main" sx={{ bgcolor: "transparent", height: '100vh', justifyContent: 'center', alignItems: 'center' }}>
          <CssBaseline />
          <Grid item xs={11} md={6} component={Paper} elevation={6} square sx={{ boxShadow: 3, width: "90%", maxWidth: 600, display: 'flex', flexDirection: 'column', alignItems: 'center', background: 'linear-gradient(10deg,white 85%, #1976d200 100%)' }}>
            <Box
              sx={{
                alignItems: 'center',
            ...
            <Box component="form" sx={{ mt: 1, p: 3 }}>
              ...
              <Button onClick={() => navigate("/login")} type="button" sx={{ marginTop: "20px", fontSize: "small" }}>
                Already have a user
              </Button>
            </Box>
          </Grid>
